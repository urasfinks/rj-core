...
import ru.jamsys.core.i360.entity.adapter.relation.RelationTypeNormal;
...
public class AdapterRelationSetNormal extends AbstractAdapter {
    ...
    private final RelationTypeNormal type;
    ...
    public AdapterRelationSetNormal(Map<String, Object> map, Scope scope) {
        ...
        this.type = RelationTypeNormal.valueOfCamelCase((String) map.get("type"));
    }
