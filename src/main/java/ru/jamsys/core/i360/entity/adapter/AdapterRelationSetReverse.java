...
import ru.jamsys.core.i360.entity.adapter.relation.RelationTypeReverse;
...
public class AdapterRelationSetReverse extends AbstractAdapter {
    ...
    private final RelationTypeReverse type;
    ...
    public AdapterRelationSetReverse(Map<String, Object> map, Scope scope) {
        ...
        this.type = RelationTypeReverse.valueOfCamelCase((String) map.get("type"));
    }
