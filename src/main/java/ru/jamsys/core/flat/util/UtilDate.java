...
public final class UtilDate {
    ...
    public static Instant parseToInstant(String text, String pattern) {
        return parseToInstant(text, pattern, DEFAULT_ZONE);
    }
    ...
    /**
     * То же, что {@link #parseToEpochMilli(String, String, ZoneId)}, но используется {@link #DEFAULT_ZONE}.
     */
    public static long parseToEpochMilli(String text, String pattern) {
        return parseToEpochMilli(text, pattern, DEFAULT_ZONE);
    }
    ...
    /**
     * То же, что {@link #parseToEpochSecond(String, String, ZoneId)}, но используется {@link #DEFAULT_ZONE}.
     */
    public static long parseToEpochSecond(String text, String pattern) {
        return parseToEpochSecond(text, pattern, DEFAULT_ZONE);
    }
    ...
    /**
     * То же, что {@link #validate(String, String, ZoneId)}, но используется {@link #DEFAULT_ZONE}.
     */
    public static boolean validate(String text, String pattern) {
        return validate(text, pattern, DEFAULT_ZONE);
    }
