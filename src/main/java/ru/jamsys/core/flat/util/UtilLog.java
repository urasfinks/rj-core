...
public class UtilLog {
    ...
    public static String shortReadString(InputStream fis) throws Exception {
    ...
    public static void shortWriteString(OutputStream fos, String data) throws Exception {
