...
public class Template {
    ...
    private void parse(String sql) {
        listTemplateItem = ru.jamsys.core.template.twix.Template.getParsedTemplate(sql);
    ...
    public CompiledSqlTemplate compile(Map<String, Object> args) throws CloneNotSupportedException {
        ...
        if (cache == null && !dynamicArgument) {
            cache = ru.jamsys.core.template.twix.Template.template(listTemplateItem, templateArgs);
        }
        if (dynamicArgument) {
            compiledSqlTemplate.setSql(ru.jamsys.core.template.twix.Template.template(listTemplateItem, templateArgs));
        } else {
