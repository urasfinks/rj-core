...
import ru.jamsys.core.i360.entity.adapter.relation.normal.ForwardRight;

class ForwardRightTest {

    @Test
    public void test() {
        // Пробросить все которые есть ["2", "3"] mask ["2", "1", "2", "3"] => ["2", "2", "3"]
        ...
        Assertions.assertEquals(result, new ForwardRight().compute(input, selection));
