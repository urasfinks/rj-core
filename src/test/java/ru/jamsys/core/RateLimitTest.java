...
//        RateLimitItemPeriodic rateLimitItemPeriodic;
    ...
    void testPeriodic() {
        ...
        RateLimitPeriodic rateLimitItemPeriodic = ManagerElement.getConfigure(RateLimitPeriodic.class, "min").get();
        ...
        rateLimitItemPeriodic = ManagerElement.getConfigure(RateLimitPeriodic.class, "hour").get();
        rateLimitItemPeriodic.setMax(999999);
        ...
        rateLimitItemPeriodic = ManagerElement.getConfigure(RateLimitPeriodic.class, "day").get();
        rateLimitItemPeriodic.setMax(999999);
        ...
        rateLimitItemPeriodic = ManagerElement.getConfigure(RateLimitPeriodic.class, "month").get();
        rateLimitItemPeriodic.setMax(999999);
    ...
    @Test
    void testTps() {
        RateLimit rateLimitTps = ManagerElement.getConfigure(RateLimitTps.class, "tps").get();
        rateLimitTps.run();
