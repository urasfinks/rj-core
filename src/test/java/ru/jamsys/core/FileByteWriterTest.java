...
class FileByteWriterTest {
    ...
    void folderNotExist() {
        try {
            ...
            test.getPropertiesNsAgent().setProperty("log.file.folder", "xxkaa");
            Assertions.fail();
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    void checkOverMaxFileWrite() {
        ...
        test.getPropertiesNsAgent().setProperty("log.file.size.kb", "1");
        test.getPropertiesNsAgent().setProperty("log.file.count", "2");
        test.getPropertiesNsAgent().setProperty("log.file.name", "default1");
    ...
    void checkNameLog() {
        ...
        test.getPropertiesNsAgent().setProperty("log.file.count", "100");
        test.getPropertiesNsAgent().setProperty("log.file.name", "default2");
    ...
    void checkRestoreExceptionShutdown() throws IOException {
        ...
        test.getPropertiesNsAgent().setProperty("log.file.name", "default3");
    ...
    void checkTime() {
        ...
        test.getPropertiesNsAgent().setProperty("log.file.name", "default4");
