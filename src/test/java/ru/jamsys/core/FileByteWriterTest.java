...
class FileByteWriterTest {
    ...
    void folderNotExist() {
        try {
            ...
            test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.folder", "xxkaa");
            Assertions.fail();
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    void checkOverMaxFileWrite() {
        ...
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.size.kb", "1");
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.count", "2");
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.name", "default1");
    ...
    void checkNameLog() {
        ...
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.count", "100");
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.name", "default2");
    ...
    void checkRestoreExceptionShutdown() throws IOException {
        ...
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.name", "default3");
    ...
    void checkTime() {
        ...
        test.getPropertiesNsAgent().setPropertyWithoutNs("log.file.name", "default4");
