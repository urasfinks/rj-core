...
class CronTest {
    ...
    public void single() {
        ...
        //Assertions.assertEquals("2024-03-07T00:00:00.000", msFormat(new Cron("0 0 0 * *").compile(curTime).getNextTimestamp()));
    }
    ...
    public void test() {
        ...
        //RateLimit test
        Assertions.assertEquals("2024-03-06T17:12:00.000", msFormat(new Cron("0 * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T18:00:00.000", msFormat(new Cron("0 0 * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-07T00:00:00.000", msFormat(new Cron("0 0 0 * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-04-01T00:00:00.000", msFormat(new Cron("0 0 0 1 *").compile(curTime).getNextTimestamp()));

        Assertions.assertNull(msFormat(new Cron("0 0 0 1 1").compile(curTime).getNextTimestamp()));

        Assertions.assertEquals("2024-03-06T17:12:01.000", msFormat(new Cron("1 * * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:12:02.000", msFormat(new Cron("2 * * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:11:05.000", msFormat(new Cron("* * * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:11:05.000", msFormat(new Cron("*/1 * * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:11:15.000", msFormat(new Cron("*/15 * * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T18:00:00.000", msFormat(new Cron("* 0 * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T18:01:00.000", msFormat(new Cron("* 1 * * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-07T01:00:00.000", msFormat(new Cron("* * 1 * * *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-04-01T00:00:00.000", msFormat(new Cron("* * * 1 * *").compile(curTime).getNextTimestamp()));
        //Assertions.assertEquals("2024-04-01T00:00:01", UtilDate.msToDataFormat(new Template("* * * 1 * *").getNext(1711918800000L)));
        Assertions.assertEquals("2024-03-06T17:11:05.000", msFormat(new Cron("* * * * 3 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:11:15.000", msFormat(new Cron("15 * * * 3 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:12:01.000", msFormat(new Cron("1 * * * 3 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:13:01.000", msFormat(new Cron("1 13 * * 3 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T18:10:01.000", msFormat(new Cron("1 10 * * 3 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T18:10:01.000", msFormat(new Cron("1 10 18 * 3 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-04-01T17:10:01.000", msFormat(new Cron("1 10 17 * 4 *").compile(curTime).getNextTimestamp()));
        Assertions.assertNull(msFormat(new Cron("1 10 17 15 4 *").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-11T00:00:00.000", msFormat(new Cron("* * * * * 1").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-12T00:00:00.000", msFormat(new Cron("* * * * * 2").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-06T17:11:05.000", msFormat(new Cron("* * * * * 3").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-07T00:00:00.000", msFormat(new Cron("* * * * * 4").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-08T00:00:00.000", msFormat(new Cron("* * * * * 5").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-09T00:00:00.000", msFormat(new Cron("* * * * * 6").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T00:00:00.000", msFormat(new Cron("* * * * * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T00:00:01.000", msFormat(new Cron("1 * * * * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T00:00:59.000", msFormat(new Cron("59 * * * * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T00:00:19.000", msFormat(new Cron("19-20 * * * * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T00:13:19.000", msFormat(new Cron("19-20 13 * * * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T14:13:19.000", msFormat(new Cron("19-20 13 14 * * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-10T14:13:19.000", msFormat(new Cron("19-20 13 14 10 * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertEquals("2024-03-17T14:13:19.000", msFormat(new Cron("19-20 13 14 17 * 7").compile(curTime).getNextTimestamp()));
        Assertions.assertNull(msFormat(new Cron("19 13 14 17 3 7").compile(curTime).getNextTimestamp()));
        Assertions.assertNull(msFormat(new Cron("19 13 14 17 3 *").compile(curTime).getNextTimestamp()));
