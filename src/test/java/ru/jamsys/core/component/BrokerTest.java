...
class BrokerTest {
    ...
    void testLiner() throws Exception {
        ...
        ExpiredMsImmutableEnvelope<XTest> t = b.pollFirst();
        Assertions.assertEquals(0, t.getValue().x, "#2");
        Assertions.assertEquals(9, b.size(), "#3");

        ExpiredMsImmutableEnvelope<XTest> t2 = b.pollLast();
    ...
    void testReference() throws Exception {
        ...
        ExpiredMsImmutableEnvelope<XTest> o1 = queue.add(obj, 6_000L);
    ...
    void testReference2() throws Exception {
        ...
        ExpiredMsImmutableEnvelope<XTest> o1 = queue.add(obj, 6_000L);
        ExpiredMsImmutableEnvelope<XTest> o2 = queue.add(obj2, 6_000L);
