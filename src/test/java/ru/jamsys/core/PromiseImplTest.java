...
class PromiseImplTest {
    ...
    void test3_1() {
        ...
        UtilLog.printInfo(PromiseImplTest.class, rateLimit);
    ...
    void testExpiration() {
        ...
        Assertions.assertEquals("TimeOut cause: ServicePromise.onPromiseTaskExpired", promise.getExceptionSource().getMessage());
